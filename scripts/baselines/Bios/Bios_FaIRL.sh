...
CURRENT="$PWD"
DATASET="Bios" #MNIST FashionMNIST BiasedMNIST Drug Bios
...
for SEED in {0..4}; do
for EPOCH in 10; do
for TAU in 1.0 2.0 5.0 10.0; do
for TOKEN_LENGTH in 128; do
for LR in 2e-5 0.0001 0.001; do
for ALPHA in 0.0005 0.001 0.002 0.01; do
